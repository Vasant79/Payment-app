...
function DescriptionSeaction({ title, content }) {
  return (
    <div className="h-60 w-80 p-5  mt-10 mb-10 flex flex-col border shadow-sm rounded-xl lg:mx-10 hover:ring hover:outline-none hover:ring-blue-300 hover:shadow-xl hover:shadow-blue-200 transition ease-in-out hover:-translate-y-1">
